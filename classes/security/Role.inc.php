...
define('ROLE_ID_SITE_ADMIN',		0x00000001); // 1
define('ROLE_ID_JOURNAL_MANAGER',	0x00000010); // 16
define('ROLE_ID_EDITOR',		0x00000100); // 256
define('ROLE_ID_REVIEWER',		0x00001000); // 4096
define('ROLE_ID_AUTHOR',		0x00010000); // 65536
define('ROLE_ID_SECTION_EDITOR',	0x00000200); // 512
